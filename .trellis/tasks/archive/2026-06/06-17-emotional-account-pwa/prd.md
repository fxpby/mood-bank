...
| Topics List | Done | `/topics` shows discovery points, questions, topics, action ideas, type/status/theme/source filters, low-pressure status copy, manual creation, and inline status changes. | Keep avoiding due dates, overdue states, streaks, or unfinished-debt language. |
